...
export default function JourneyIntro({
  ...
  const stats = [
    { value: yearsExperience, suffix: '+', label: 'Years Experience', description: 'Full Stack Development' },
    { value: projectCount, suffix: '+', label: 'Projects Built', description: 'SaaS & MVP' },
    { value: skillsCount, suffix: '', label: 'Technologies', description: 'Mastered & applied' },
    { value: 15, suffix: '+', label: 'Workflows Shipped', description: 'Automation & integrations' },
  ];
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            From cross-platform mobile apps to AI-powered SaaS and Web3-enabled features, my journey has been about
            shipping production-ready products and scalable systems that deliver real business impact.
          </motion.p>
        </motion.div>
