...
import { PRIMARY_SOCIAL_LINKS } from '@/constants/social';
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Whether you're looking to build web applications, mobile apps, AI-powered features, or modern SaaS solutions. I'd love to hear about your project.
          </motion.p>
            ...
            {[
              {
                icon: faLightbulb,
                title: 'AI Solutions',
                description: 'Practical AI features like chatbots, agents, and automation that help your product work smarter.',
              },
              {
                icon: faCode,
                title: 'Web & Mobile Apps',
                description: 'Modern, fast, and reliable applications built for real users and real business needs.',
              },
              {
                icon: faGithub,
                title: 'Collaboration',
                description: 'Long-term partnerships, product development, and meaningful technical projects.',
              },
            ].map((item, index) => (
              <motion.div
                key={item.title}
