        ...
        <div className="relative aspect-video overflow-hidden">
          {image ? (
            ...
            <div className="w-full h-full bg-gradient-to-br from-neural-blue/20 to-synapse-cyan/20 flex items-center justify-center">
              <FontAwesomeIcon icon={faExternalLinkAlt} className="w-16 h-16 text-neural-blue/30" />
            </div>
          )}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-light-text-secondary dark:text-muted-steel max-w-2xl mx-auto">
            From AI-powered applications to enterprise solutions—each project tells a story of challenges solved and impact delivered
          </p>
        </motion.div>
