...
const values = [
  {
    ...
    description: 'I bridge the gap between business requirements and technical implementation—discussing needs with stakeholders and translating them into scalable software solutions.',
  },
  {
    icon: faUsers,
    title: 'User-Centric Design',
    description: 'Every application I build starts with understanding the user\'s workflow. Complex features should become accessible, not add cognitive overhead.',
  },
  {
    icon: faCode,
...
const expertiseAreas = [
  {
    ...
    description: 'LLM-based chatbots, agents, RAG pipelines, and voice workflows that ship to production',
    technologies: ['LLMs', 'RAG', 'Python', 'STT/TTS'],
    color: 'neural-blue',
  },
  {
    icon: faCubes,
    title: 'Web3 & Blockchain',
    description: 'Wallet authentication, token logic, and smart contract integrations for decentralized apps',
    technologies: ['Solidity', 'Hardhat', 'Ethers.js', 'MetaMask'],
    color: 'synapse-cyan',
  },
  {
    icon: faServer,
    title: 'SaaS & Backend Systems',
    description: 'APIs, auth, background jobs, and cloud deployments for scalable products',
    technologies: ['Laravel', 'FastAPI', 'Supabase', 'AWS'],
    color: 'plasma-purple',
  },
  {
    icon: faRocket,
    title: 'Web & Mobile Apps',
    description: 'Modern UIs and cross-platform mobile experiences with strong UX and performance',
...
function AchievementCard({ achievement, index }) {
  ...
  const icons = {
    'Years Experience': faChartLine,
    'Test Coverage': faAward,
    'Cloud Platforms': faServer,
    'AI Solutions': faBrain,
    'Web3 Features': faCubes,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-light-text-secondary dark:text-muted-steel mb-4 leading-relaxed">
                I’m an AI & Web3 Full-Stack Developer with hands-on experience building web and mobile applications, AI-powered chatbots/agents, and blockchain-enabled product features.
              </p>

              <p className="text-base text-light-text-secondary dark:text-muted-steel mb-6 leading-relaxed">
                Skilled in React, Next.js, React Native, Flutter, Laravel, and Python, I deliver MVPs and production systems end-to-endintegrating LLM workflows (agents, RAG, voice) and Web3 capabilities like wallet authentication, token logic, and smart contract interactions.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-light-text-secondary dark:text-muted-steel max-w-2xl mx-auto">
              From AI agents to Web3 integrations, I bring a full-stack skillset designed to ship real products
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-light-text-secondary dark:text-muted-steel mb-8">
              Whether you need web applications, mobile apps, AI-powered features, or modern SaaS solutions. I'd love to hear about your project and explore how we can collaborate.
            </p>
