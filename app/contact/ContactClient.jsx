...
import { PRIMARY_SOCIAL_LINKS, CONTACT_INFO, EXTENDED_SOCIAL_LINKS } from '@/constants/social';
...
export default function ContactClient({ aboutContent }) {
  ...
  // Use contact info from constants or fallback to metadata
  const contactEmail = CONTACT_INFO?.email || email;
  ...
  const socialLinks = EXTENDED_SOCIAL_LINKS.map(link => ({
    ...link,
        ...
        <motion.div className="lg:col-span-2 space-y-6" variants={staggerItem}>
          ...
          <div className="glass-card p-6">
            ...
            <ul className="space-y-4">
              {contactEmail && (
                <li>
                  <div className="flex items-center gap-3 text-light-text-secondary dark:text-muted-steel group">
                    <a
                      href={`mailto:${contactEmail}`}
                      className="w-10 h-10 rounded-lg bg-neural-blue/10 flex items-center justify-center group-hover:bg-neural-blue/20 transition-colors focus:outline-none focus:ring-2 focus:ring-neural-blue/40"
                      aria-label="Email"
                      title="Email"
                    >
                      <FontAwesomeIcon icon={faEnvelope} className="text-neural-blue" />
                    </a>
                    <span className="text-sm break-all select-text cursor-text">
                      {contactEmail}
                    </span>
                  </div>
                </li>
                ...
                <li>
                  <div className="flex items-center gap-3 text-light-text-secondary dark:text-muted-steel group">
                    <a
                      ...
                      className="w-10 h-10 rounded-lg bg-signal-green/10 flex items-center justify-center group-hover:bg-signal-green/20 transition-colors focus:outline-none focus:ring-2 focus:ring-signal-green/40"
                      aria-label="Phone"
                      title="Call"
                    >
                      <FontAwesomeIcon icon={faPhone} className="text-signal-green" />
                    </a>
